...
Conductor automated tests & 36 passed, 0 failed, 0 skipped \\
...
Automated testing & \statusgreen{Green} & Thirty-eight automated tests passed: thirty-six for Conductor and two for the MCP server, with no failures or skips. \\
