...
- [ ] **2.1 - Skills Operations**
  - [ ] Import `logAction` in [conductor-app/features/skills/server-functions.ts](conductor-app/features/skills/server-functions.ts)
...
- [ ] **2.2 - Workflow Operations**
  - [ ] Import `logAction` in [conductor-app/features/workflows/server-functions.ts](conductor-app/features/workflows/server-functions.ts)
...
- Schema: [conductor-app/prisma/schema.prisma](conductor-app/prisma/schema.prisma)
- Services: [conductor-app/features/logging/](conductor-app/features/logging/)
- API Routes: [conductor-app/app/api/audit-logs/](conductor-app/app/api/audit-logs/)
- Docs: [conductor-app/features/logging/README.md](conductor-app/features/logging/README.md)

---

**Need help?** See [conductor-app/features/logging/README.md](conductor-app/features/logging/README.md) for detailed documentation.
