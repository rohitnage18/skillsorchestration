...
export async function GET(req: Request, context: RouteContext) {
  try {
    ...
    return jsonResponse(await getWorkflow(getOwnerId(req.headers), workflowId));
  } catch (error) {
...
export async function PATCH(req: Request, context: RouteContext) {
  try {
    ...
    return jsonResponse(await updateWorkflow(getOwnerId(req.headers), workflowId, input));
  } catch (error) {
...
export async function DELETE(req: Request, context: RouteContext) {
  try {
    const { workflowId } = await context.params;
    return jsonResponse(await deleteWorkflow(getOwnerId(req.headers), workflowId));
  } catch (error) {
